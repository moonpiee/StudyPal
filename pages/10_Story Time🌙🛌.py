...
session_id_runn="runn_chat_history10"
session_id_wo_runn="wo_runn_chat_history10"
st.title("Study Pal🌱📚💪")
...
instruction = instructions_lis[9]
...
match instruction:
    ...
    case "Story Time":
        instruction_desc=f"In {sel_language} tell an interesting story. Ask no questions, use markdown format. Use emojis, symbols wherever if needed. Use markdown format"
    case "More Fun Games":
...
click = st.button("It's Story Time!!")
