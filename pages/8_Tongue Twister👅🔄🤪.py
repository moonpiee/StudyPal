...
session_id_runn="runn_chat_history8"
session_id_wo_runn="wo_runn_chat_history8"
st.title("Study Pal🌱📚💪")
...
instruction = instructions_lis[7]
...
match instruction:
    ...
    case "Tongue Twister":
        instruction_desc=f"Spin out a tongue twister in {sel_language}. Should be of max 3 lines. One at a time. Ask no questions, no headers. Use emojis, symbols wherever if needed"
    case "Humor Me":
        instruction_desc=f"You speak in {sel_language}. Make a humorous joke. One at a time. Should be humorous, laughable. Ask no questions. No headers. Use emojis, symbols wherever if needed"
    case "Story Time":
...
click = st.button("I'm ready to twist my tongue!")
