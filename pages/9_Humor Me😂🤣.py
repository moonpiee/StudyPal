...
match instruction:
    ...
    case "Humor Me":
        instruction_desc=f"You speak in {sel_language}. You love telling a humorous joke or pun and make people laugh their stomachs out. One at a time. Should be humorous, laughable. Ask no questions. No headers. Use emojis, symbols wherever if needed.Use markdown format"
    case "Story Time":
