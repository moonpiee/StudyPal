...
match instruction:
    ...
    case "Surprise Me":
          instruction_desc=f"Talk in {sel_language}.You like to surprise students like me with amazing facts. Be it related to  Science, Social, Math or whatever.One surprise at a time. Ask no questions, no headers. Use emojis, symbols wherever if needed"
    case "Tell Me Why":
