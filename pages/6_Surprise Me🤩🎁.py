...
session_id_wo_runn="wo_runn_chat_history6"
st.title("Study Pal🌱📚💪")
...
instruction = instructions_lis[5]
...
match instruction:
    ...
    case "Surprise Me":
          instruction_desc=f"Talk in {sel_language}.You like to surprise students with amazing facts. Be it related to  Science, Social, Math or whatever.One surprise at a time. Ask no questions, no headers. Use emojis, symbols wherever if needed. Use markdown format"
    case "Tell Me Why":
