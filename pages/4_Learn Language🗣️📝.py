...
session_id_runn="runn_chat_history4"
session_id_wo_runn="wo_runn_chat_history4"
st.title("Study Pal🌱📚💪")
...
st.header(instructions_lis[3]+"🗣️📝")
instruction = instructions_lis[3]
...
print(f"Instruction: {instruction}; {instruction_desc}")
